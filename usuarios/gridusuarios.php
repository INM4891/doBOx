...
$resultado = $mysqli->query("SELECT * FROM tbl_usuarios");
?>
            ...
            <tbody>
                ...
                while ($fila = $resultado->fetch_assoc()) { ?>
                    ...
                    <tr>
                        ...
                        <td class="celdacentrada"><a href="modificar_usuario.php?ID=<?php echo $fila['ID']; ?>"><i class="fa fa-fw fa-pencil link"></i><a href="eliminar_usuario.php?ID=<?php echo $fila['ID']; ?>"><i class="fa fa-fw fa-trash link"></i></td>

...
<body>
    ...
    <div class="main">
        <h1>Eliminar Entidad</h1>

        <form name="eliminar_entidad" action="elimina_entidad.php" method="POST">


            <label for="id">Id:</label>
            <input type="text" name="id" value="<?php echo $fila['ID_ENTIDAD']; ?>" />
            ...
            <input class="guardar" type="submit" name="elimina_entidad" value="Eliminar" />

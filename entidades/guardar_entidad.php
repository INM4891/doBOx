...
$query = "INSERT INTO tbl_entidades (NOMBRE, CIF, TELEFONO, EMAIL) VALUES ('$nombre','$cif','$telefono', '$email')";
...
<body>
    ...
    <div class="main">
        ...
        <?php if ($resultado > 0) { ?>
            <h1>Entidad guardada</h1>
        <?php } else { ?>
            <h1>Error al guardar entidad</h1>
        <?php    } ?>


        <button onclick="location.href='nueva_entidad.php'" class="guardar">Nuevo</button>
        <button onclick="location.href='gridentidades.php'" class="guardar">Ver Entidades </button>

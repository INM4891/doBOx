...
$query = "SELECT * FROM tbl_entidades WHERE ID_ENTIDAD= '" . $id . "'";
...
<head>
    ...
    <title>Actualizar Entidad</title>
...
<body>
    ...
    <div class="main">
        ...
        <form name="modificar_entidad" action="modifica_entidad.php" method="POST">

            <label for="id">Id:</label>
            <input type="text" name="id" value="<?php echo $fila['ID_ENTIDAD']; ?>" readonly/>
            ...
            <input class="guardar" type="submit" name="modifica_entidad" value="Actualizar" />

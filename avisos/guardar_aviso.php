...
$query = "INSERT INTO tbl_avisos (TITULO, DESCRIPCION, FECHA) VALUES ('$titulo','$descripcion','$fecha')";
...
<body>
    ...
    <div class="main">
        ...
        <?php if ($resultado > 0) { ?>
            <h1>Aviso guardado</h1>
        <?php } else { ?>
            <h1>Error al guardar Aviso</h1>
        <?php    } ?>

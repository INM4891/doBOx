...
<body>
    ...
    <div class="main">
        ...
        <form name="eliminar_documento" action="elimina_documento.php" method="POST">
            ...
            <input type="text" name="archivo" value="<?php echo $fila['ARCHIVO']; ?>" />

            <input class="guardar" type="submit" name="elimina_documento" value="Eliminar" />

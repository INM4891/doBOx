...
$resultado = $mysqli->query("SELECT * FROM tbl_avisos");
...
$query = "UPDATE tbl_documentos SET NOMBRE = '" . $nombre . "', TIPO = '" . $tipo . "', DESCRIPCION = '" . $descripcion . "', FECHA = '" . $fecha . "', FECHA_VTO = '" . $fechavto . "', ARCHIVO = '" . $archivo . "' WHERE ID = '" . $id . "'";
...
<body>
    ...
    <div class="main">
        ...
        <?php } else { ?>
            <h1>Error al actualizar Documento</h1>
        <?php    } ?>
